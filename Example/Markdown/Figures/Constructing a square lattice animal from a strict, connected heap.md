...
subfigures:
  - "[[A strict, connected heap H with three minimal dimers]]"
  - "[[We partition the heap into three pyramids by iteratively pushing all minimal dimers except the rightmost one up]]"
  - "[[Replace each cell by a dimer]]"
  - "[[Translating the separated pyramids and pushing them together]]"
tags:
  - Figure
---
