...
subfigures:
  - "[[A directed lattice animal D_s on the square grid with its source highlighted in grey]]"
  - "[[The corresponding strict pyramid V(D_s)]]"
  - "[[A directed lattice animal D_t on the triangular grid with its source highlighted in grey]]"
  - "[[The corresponding general pyramid V(D_t)]]"
tags:
  - Figure
---
#### Figure: Constructing pyramids from directed lattice animals

![[Constructing pyramids from directed lattice animals.PNG]]
