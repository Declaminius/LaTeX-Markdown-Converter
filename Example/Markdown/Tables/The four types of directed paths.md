...
\end{tabular}
\caption[The four types of directed paths.]{The four types of directed paths: walks, bridges, meanders and excursions and the corresponding generating functions \[[[Basic analytic combinatorics of directed lattice paths|Banderier & Flajolet, 2002, Fig.~1]]\].}
\label{table:4paths}
\end{table}
```