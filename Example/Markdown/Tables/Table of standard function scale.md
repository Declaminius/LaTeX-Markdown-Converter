...
\end{array}
\]
\caption[Table of standard function scale.]{Table of commonly encountered functions within the standard function scale \[[[Analytic combinatorics|Flajolet & Sedgewick, 2009, Figure VI.5, p.~388]]\].}
\label{tab:standard_function_scale}
\end{table}
```